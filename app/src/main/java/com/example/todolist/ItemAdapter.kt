...
class  ItemAdapter (private val context: Context,
                   private val dataSet: MutableList<ToDo>) : RecyclerView.Adapter<ItemAdapter.ItemViewHolder>() {

    var onItemClick: ((ToDo) -> Unit)? = null

    inner class ItemViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        val textTaskName: TextView = view.findViewById(R.id.textTaskName)
        val textTaskDealine: TextView = view.findViewById(R.id.textTaskDeadline)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.textTaskDealine.text = todo.deadline
    }
